<!DOCTYPE html>
<%@page import="ProjectLibrary.dto.Faculty"%>
<%@page import="ProjectLibrary.dao.facultyDao"%>
...
<body>
  ...
  <% 
    ...
    String facultyName = (String) session1.getAttribute("fname"); 
    String email = (String) session1.getAttribute("femail");
  
  
     facultyDao fDao = new facultyDao();  
     Faculty student = fDao.fetch(email);
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="student-info">
                ...
                <div class="info-item">
                    <strong>ID:</strong> <span><%= student.getId() %></span>
                </div>
                <div class="info-item">
